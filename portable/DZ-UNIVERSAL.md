...
Also include any accepted risk with its exact scope and every unverified item. A handoff must allow the next AI to continue without treating a prior pause, cancellation, or risk acceptance as proof of completion.
